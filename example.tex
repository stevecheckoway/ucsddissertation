...
% etc. If you have code listings, you can use \lstlistoflistings to
% have it be produced here as well.
\tableofcontents
\listoffigures
\listoftables
...
simply typeset it and hope it is accepted.
\end{preface}

% Your fancy acks here. Keep in mind you need to ack each paper you
% use. See the examples here.
...
For facing caption pages, see Table~\ref{tab:facing}.
\begin{figure}
\centering
